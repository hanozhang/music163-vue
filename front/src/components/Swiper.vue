...
export default {
  ...
  data () {
    return {
    	imgData:[
    	   {url:require('../../static/img/lunbo1.png')},
    	   {url:require('../../static/img/lunbo2.png')},
    	   {url:require('../../static/img/pink1.jpg')},
    	   {url:require('../../static/img/lunbo4.png')},
         {url:require('../../static/img/5.jpg')}
    	],
    	bgData:[
    	  {url:require('../../static/img/lunbo(1).png')},
    	  {url:require('../../static/img/lunbo(2).png')},
    	  {url:require('../../static/img/pink.jpg')},
    	  {url:require('../../static/img/lunbo(4).png')},
        {url:require('../../static/img/pink.jpg')}
    	],
    	imgId:0,
    	// liId:0,
...
.download{
  ...
  width: 254px;
  height: 336px;
  background: url('../../static/img/009.png') no-repeat;
}
.download a{
	display: block;
  width: 215px;
